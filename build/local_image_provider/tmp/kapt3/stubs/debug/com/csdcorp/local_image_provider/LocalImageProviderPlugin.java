...
public final class LocalImageProviderPlugin implements io.flutter.embedding.engine.plugins.FlutterPlugin, io.flutter.plugin.common.MethodChannel.MethodCallHandler, io.flutter.plugin.common.PluginRegistry.RequestPermissionsResultListener, io.flutter.embedding.engine.plugins.activity.ActivityAware {
    ...
    private final java.lang.String getStringColumn(android.database.Cursor imageCursor, int columnIndex, java.lang.String defaultValue) {
        return null;
    }
    
    private final int getIntColumn(android.database.Cursor imageCursor, int columnIndex, int defaultValue) {
        return 0;
    }
    
    private final long getLongColumn(android.database.Cursor imageCursor, int columnIndex, long defaultValue) {
        return 0L;
    }
